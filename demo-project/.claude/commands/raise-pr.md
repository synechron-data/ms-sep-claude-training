...
4. Check if the branch name or commits reference an issue number (e.g.
   fix/issue-204 or "closes #204"). Extract it if present.
...
Body format:
  ...
  ## Why it changed
  - The problem or issue this PR resolves (reference issue number if found)
